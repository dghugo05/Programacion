    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="panel panel-info">
                ...
                <form method="get" action="grabarProductomodificado.jsp">
                    <br>
                    <div class="form-group"> 
                        <label>&nbsp;&nbsp; Código:&nbsp;</label><input type="text" size="5" name="codigo" value="<%= Long.valueOf(request.getParameter("codigo")) %>" readonly>
                    </div>
                    <div class="form-group">
